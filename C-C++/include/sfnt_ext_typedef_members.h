...
typedef CK_RV CK_ENTRY (CK_PTR CK_CA_LKMInitiatorChallenge)(CK_SESSION_HANDLE hSession,CK_OBJECT_HANDLE hAKObjectHandle,CK_OBJECT_HANDLE hDKObjectHandle,CK_ULONG ulHashMech,CK_LKM_TOKEN_ID_PTR pInitiatorID,CK_LKM_TOKEN_ID_PTR pReceiverID,CK_CHAR_PTR pChallengeBuf,CK_ULONG_PTR pulChallengeBufSize);
typedef CK_RV CK_ENTRY (CK_PTR CK_CA_LKMReceiverResponse)(CK_SESSION_HANDLE hSession,CK_OBJECT_HANDLE hAKObjectHandle,CK_OBJECT_HANDLE hDKObjectHandle,CK_ULONG ulHashMech,CK_LKM_TOKEN_ID_PTR pReceiverID,CK_CHAR_PTR pChallengeBuf,CK_ULONG ulChallengeBufSize,CK_CHAR_PTR pResponseBuf,CK_ULONG_PTR pulResponseBufSize);
typedef CK_RV CK_ENTRY (CK_PTR CK_CA_LKMInitiatorComplete)(CK_SESSION_HANDLE hSession,CK_CHAR_PTR pResponseBuf,CK_ULONG ulResponseBufSize,CK_ATTRIBUTE_PTR pSCKTemplate,CK_ULONG usSCKAttributeCount,CK_ATTRIBUTE_PTR pSAKTemplate,CK_ULONG usSAKAttributeCount,CK_CHAR_PTR pCompleteBuf,CK_ULONG_PTR pulCompleteBufSize,CK_OBJECT_HANDLE_PTR phSCKObjectHandle,CK_OBJECT_HANDLE_PTR phSAKObjectHandle);
typedef CK_RV CK_ENTRY (CK_PTR CK_CA_LKMReceiverComplete)(CK_SESSION_HANDLE hSession,CK_CHAR_PTR pCompleteBuf,CK_ULONG ulCompleteBufSize,CK_ATTRIBUTE_PTR pSCKTemplate,CK_ULONG usSCKAttributeCount,CK_ATTRIBUTE_PTR pSAKTemplate,CK_ULONG usSAKAttributeCount,CK_OBJECT_HANDLE_PTR phSCKObjectHandle,CK_OBJECT_HANDLE_PTR phSAKObjectHandle);
